      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-300 text-sm">
              Create, mint, and share your digital art on the Solana blockchain.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/mint-nft" className="text-gray-300 hover:text-white transition-colors">
                  Mint NFT
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/buy-tokens" className="text-gray-300 hover:text-white transition-colors">
                  Buy Tokens
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Unity. All rights reserved.
          </p>
